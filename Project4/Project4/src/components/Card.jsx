...
function Card(props) {
  return (
    <div className='lg:w-[18vw] md:w-[30vw] sm:w-[45vw] rounded-xl py-8 px-8 flex items-center flex-col text-center bg-white text-black border'>
            <img className='h-24 w-24 rounded-full object-top object-cover' src={props.elem.imageUrl} alt="" />
